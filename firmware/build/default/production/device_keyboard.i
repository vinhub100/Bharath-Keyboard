...
static E2_REPORT e2Report __attribute__((address(0x510)));





static volatile E2_OUT_REPORT e2outReport __attribute__((address(0x518)));
...
static void* ep2_handle;
static void* ep2_out_handle;
E2_REPORT old_ep2report;
# 310 "device_keyboard.c"
void APP_KeyboardInit(void)
{
    ...
    ep2_out_handle = USBTransferOnePacket(2,0,(uint8_t*)&e2outReport,sizeof(e2outReport));
}
# 350 "device_keyboard.c"
...
void APP_KeyboardTasks(void)
{
    ...
    if(((ep2_handle != 0x0000) && ((*(volatile uint8_t*)ep2_handle & 0x80) != 0x00)) == 0){
            ...
            if(shd_send == 1){
                ...
                ep2_handle = USBTransferOnePacket(2,1,(uint8_t*)&e2Report,sizeof(e2Report));
...
# 686 "device_keyboard.c"
    ...
    if(((ep2_out_handle != 0x0000) && ((*(volatile uint8_t*)ep2_out_handle & 0x80) != 0x00)) == 0){
        ep2_out_handle = USBTransferOnePacket(2,0,(uint8_t*)&e2outReport,sizeof(e2outReport));
    }
