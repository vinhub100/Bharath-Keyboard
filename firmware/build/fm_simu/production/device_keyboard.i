...
# 2 "<built-in>" 2
# 1 "device_keyboard.c" 2
# 25 "device_keyboard.c"
...
# 26 "device_keyboard.c" 2
# 1 "/opt/microchip/xc8/v2.05/pic/include/c99/string.h" 1 3
# 10 "/opt/microchip/xc8/v2.05/pic/include/c99/string.h" 3
...
# 32 "device_keyboard.c" 2

# 1 "./status_led.h" 1
# 37 "./status_led.h"
void APP_LEDUpdateUSBStatus(void);
# 34 "device_keyboard.c" 2
# 48 "device_keyboard.c"
...
# 92 "device_keyboard.c"
typedef struct
{
# 110 "device_keyboard.c"
    union
    {
        uint8_t value;
        struct
...
# 133 "device_keyboard.c"
    unsigned :8;
# 177 "device_keyboard.c"
    uint8_t keys[6];
...
typedef union
{
    ...
    struct
    {
# 205 "device_keyboard.c"
        unsigned numLock :1;
        unsigned capsLock :1;
        unsigned scrollLock :1;
        unsigned compose :1;
        unsigned kana :1;
# 220 "device_keyboard.c"
        unsigned :3;
    } leds;
...
void* ep2_handle;
uint8_t old_ep2buf[8];
# 280 "device_keyboard.c"
...
{{0x3e,0x00,1},{0x3f,0x00,1},{0x40,0x00,1},{0x41,0x00,1},{0x42,0x00,1},{0x43,0x00,1},{0x44,0x00,1},{0x45,0x00,1}},
{{0x21,0x00,1},{0x1e,0x00,1},{0x1f,0x00,1},{0x20,0x00,1},{0x22,0x00,1},{0x23,0x00,1},{0x24,0x00,1},{0x25,0x00,1}},
{{0x18,0x40,1},{0x15,0x40,1},{0x17,0x40,1},{0x1c,0x40,1},{0x0c,0x40,1},{0x14,0x40,1},{0x1a,0x40,1},{0x08,0x40,1}},
{{0x35,0x00,1},{0x39,0x00,1},{0x2b,0x00,1},{0x29,0x00,1},{0x3a,0x00,1},{0x3b,0x00,1},{0x3c,0x00,1},{0x3d,0x00,1}},
{{0x26,0x00,1},{0x27,0x00,1},{0x2d,0x00,1},{0x2e,0x00,1},{7,0x00,3},{6,0x00,3},{5,0x00,3},{1,0x00,3}},
{{0x00,0x00,0x00},{2,0x00,3},{0x49,0x00,1},{0x4a,0x00,1},{0x4b,0x00,1},{0x4e,0x00,1},{0x4d,0x00,1},{0x4c,0x00,1}},
{{0x16,0x40,1},{0x07,0x40,1},{0x31,0x00,1},{4,0x00,3},{3,0x00,3},{0x12,0x40,1},{0x13,0x40,1},{0x04,0x40,1}},
{{0x14,0x00,1},{0x15,0x00,1},{0x17,0x00,1},{0x09,0x40,1},{0x0a,0x40,1},{0x0b,0x40,1},{0x1a,0x00,1},{0x08,0x00,1}},
{{0x16,0x00,1},{0x1b,0x40,1},{0x0e,0x40,1},{0x1d,0x40,1},{0x04,0x00,1},{0x07,0x00,1},{0x09,0x00,1},{0x0f,0x40,1}},
{{0x2a,0x00,1},{0x30,0x00,1},{0x0c,0x00,1},{0x18,0x00,1},{0x1c,0x00,1},{0x12,0x00,1},{0x2f,0x00,1},{0x13,0x00,1}},
{{0x0e,0x00,1},{0x0b,0x00,1},{0x34,0x00,1},{0x33,0x00,1},{0x0f,0x00,1},{0x28,0x00,1},{0x0d,0x00,1},{0x0a,0x00,1}},
{{0x19,0x00,1},{0x1b,0x00,1},{0x05,0x40,1},{0x06,0x00,1},{0x19,0x40,1},{0x1d,0x00,1},{0x06,0x40,1},{0x11,0x40,1}},
{{0xe6,0x40,2},{0xe3,0x08,2},{0xe1,0x02,2},{0xe2,0x04,2},{0x0d,0x40,1},{0xe7,0x80,2},{0x2c,0x00,1},{0xe0,0x01,2}},
{{0x38,0x00,1},{0x37,0x00,1},{0x36,0x00,1},{0x10,0x00,1},{0x11,0x00,1},{0x05,0x00,1},{0x00,0x00,0x00},{0xe5,0x20,2}},
{{0x5a,0x00,1},{0x5d,0x00,1},{0x60,0x00,1},{0x54,0x00,1},{0x53,0x00,1},{0x5f,0x00,1},{0x5c,0x00,1},{0x59,0x00,1}},
{{0x56,0x00,1},{0x57,0x00,1},{0x58,0x00,1},{0x63,0x00,1},{0x5b,0x00,1},{0x5e,0x00,1},{0x61,0x00,1},{0x55,0x00,1}},
{{0x52,0x00,1},{0x50,0x00,1},{0x51,0x00,1},{0x4f,0x00,1},{0xe4,0x10,2},{0x62,0x00,1},{0x65,0x00,1},{0x00,0x00,0x00}}
};
...
void SortSendList(void){
    ...
    for(uint8_t j = 0;j < SendListCount;j++){ SendList[j] = (KeyStruct){.keyCode = 0,.modifier = 0,.type = 0};}
...
# 566 "device_keyboard.c"
    ...
    for(uint8_t j = 0;j < ModListCount;j++){ ModKeyList[j] = (KeyStruct){.keyCode = 0,.modifier = 0,.type = 0}; }
    for(uint8_t j = 0;j < CharListCount;j++){ CharKeyList[j] = (KeyStruct){.keyCode = 0,.modifier = 0,.type = 0}; }
    ModListCount = 0;
    CharListCount = 0;



    if(((ep2_handle != 0x0000) && ((*(volatile uint8_t*)ep2_handle & 0x80) != 0x00)) == 0){


        if(EP2ListCount > 0){
            uint8_t ep2buf[8] = {0,0,0,0,0,0,0,0};
            for(uint8_t j = 0; j < EP2ListCount; j++){
                ep2buf[j] = EP2KeyList[j].keyCode;
            }

            uint8_t shd_send = 0;

            for(uint8_t j = 0; j < 8;j++){
                if(ep2buf[j] != old_ep2buf[j]){
                   shd_send = 1;
                   break;
                }
            }
            ...
            if(shd_send == 1){
                ...
                ep2_handle = USBTransferOnePacket(2,1,(uint8_t*)&ep2buf,8);

                for(uint8_t j = 0;j < 8 ;j++){old_ep2buf[j]=ep2buf[j];}

            }
        }
    }

    for(uint8_t j = 0;j < EP2ListCount;j++){ EP2KeyList[j] = (KeyStruct){.keyCode = 0,.modifier = 0,.type = 0}; }
    EP2ListCount = 0;
# 669 "device_keyboard.c"
