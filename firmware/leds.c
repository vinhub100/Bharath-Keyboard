...
#define LED_E1_LAT LATEbits.LATE0
#define LED_E2_LAT LATEbits.LATE1
#define LED_E3_LAT LATEbits.LATE2
//#define LED_D4_LAT LATDbits.LATD3

#define LED_E1_TRIS TRISEbits.TRISE0
#define LED_E2_TRIS TRISEbits.TRISE1
#define LED_E3_TRIS TRISEbits.TRISE2
//#define LED_D4_TRIS TRISDbits.TRISD3

#define LED_E1_ANSEL ANSELEbits.ANSE0
#define LED_E2_ANSEL ANSELEbits.ANSE1
#define LED_E3_ANSEL ANSELEbits.ANSE2
...
bool LED_Get(LED led)
{
    ...
    {
        case LED_E1:
            return ( (LED_E1_LAT == LED_ON) ? true : false );

        case LED_E2:
            return ( (LED_E2_LAT == LED_ON) ? true : false );
			
        case LED_E3:
            return ( (LED_E3_LAT == LED_ON) ? true : false );
...
void LED_Enable(LED led)
{
    ...
    {
        case LED_E1:
            LED_E1_TRIS = PIN_OUTPUT;
            LED_E1_ANSEL = PIN_DIGITAL;
            break;

        case LED_E2:
            LED_E2_TRIS = PIN_OUTPUT;
            LED_E1_ANSEL = PIN_DIGITAL;
            break;
			
        case LED_E3:
            LED_E3_TRIS = PIN_OUTPUT;
            LED_E1_ANSEL = PIN_DIGITAL;
            break;
